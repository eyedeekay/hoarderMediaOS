...
docker-copy:
	docker cp hoarder-build:os_backups/tv-*amd64.hybrid.iso . ; \
	docker cp hoarder-build:os_backups/tv-*amd64.hybrid.iso.sha256sum . ; \
	docker cp hoarder-build:os_backups/tv-*amd64.hybrid.iso.sha256sum.asc . ; \
	docker cp hoarder-build:os_backups/tv-*amd64.files . ; \
	docker cp hoarder-build:os_backups/tv-*amd64.contents . ; \
	docker cp hoarder-build:os_backups/tv-*amd64.hybrid.iso.zsync . ; \
	docker cp hoarder-build:os_backups/tv-*amd64.packages . ;
