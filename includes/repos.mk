...
devuan-key:
	...
	gpg --keyserver pgp.mit.edu --recv-keys 94532124541922FB; \
	...
	gpg --keyserver pgp.mit.edu --recv-keys EF0F382A1A7B6500; \
...
i2pd-repo:
	...
	gpg --keyserver pgp.mit.edu --recv-keys 66F6C87B98EBCFE2; \
...
tor-repo:
	...
	gpg --keyserver pgp.mit.edu --recv-keys A3C4F0F979CAA22CDBA8F512EE8CBC9E886DDD89; \
...
get-keys:
	gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg --recv-keys 94532124541922FB; \
	yes | gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg  --armor --export 94532124541922FB > keyrings/devuan.asc; \
	yes | gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg  --export 94532124541922FB > keyrings/devuan.gpg; \
	gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg --recv-keys 7638D0442B90D010 ; \
	yes | gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg --armor --export 7638D0442B90D010 > keyrings/debian.asc; \
	yes | gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg  --export 7638D0442B90D010 > keyrings/debian.gpg; \
	apt-key exportall | tee keyrings/local.asc; \
	cp /usr/share/keyrings/*-archive-keyring.gpg keyrings

import-keys:
	gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg --import keyrings/*.gpg; \
	gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg --import keyrings/*.asc; \
	gpg --keyserver pgp.mit.edu --no-default-keyring --keyring repokeys.gpg --import /usr/share/keyrings/*-archive-keyring.gpg; \
	true
